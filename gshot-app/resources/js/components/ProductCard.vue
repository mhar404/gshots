        ...
        <template v-else>
            ...
            <div class="p-3 sm:p-4 md:p-5 text-gray-200 flex flex-col grow">
                ...
                <button
                    ...
                    class="mt-auto flex items-center justify-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-full bg-red-600 hover:bg-red-700 text-white font-medium text-sm sm:text-base cursor-pointer"
                >
